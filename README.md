...
2. Download the ***latest*** version from [Releases](https://github.com/Desco14/WaterSolver/releases/)
3. Put it to your **mods** folder
4. Launch your instance
5. **START SOLVING!**

## Contribution
- **Clone** the repository using `git clone https://github.com/Desco14/WaterSolver/`
...
## Got a problem?
- Make an **issue** ticket [here](https://github.com/Desco14/WaterSolver/issues)
